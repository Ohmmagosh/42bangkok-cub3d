...
/*   Updated: 2023/04/27 16:20:59 by rchiewli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	hook(int key, t_pro *p)
{
	...
	if (key == 13)
	{
		...
		if(p->map.map[(int)(p->tline.pos.y)][(int)(p->tline.pos.x + p->di.x * step)] == '0')
			p->tline.pos.x += p->di.x * step;
		if(p->map.map[(int)(p->tline.pos.y + p->di.y * step)][(int)(p->tline.pos.x)] == '0')
	...
	else if (key == 0)
	{
		...
		if (p->map.map[(int)(p->tline.pos.y)][(int)(p->tline.pos.x + right_x * step)] == '0')
			p->tline.pos.x += right_x * step;
		// Check if the next position to the right in the y direction is '0'
		if (p->map.map[(int)(p->tline.pos.y + right_y * step)][(int)(p->tline.pos.x)] == '0')
	...
	else if (key == 2)
	{
		...
		if (p->map.map[(int)(p->tline.pos.y)][(int)(p->tline.pos.x + left_x * step)] == '0')
			p->tline.pos.x += left_x * step;
		// Check if the next position to the left in the y direction is '0'
		if (p->map.map[(int)(p->tline.pos.y + left_y * step)][(int)(p->tline.pos.x)] == '0')
